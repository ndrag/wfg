...
(0,_inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    ...
    }).use(plugin).use(ziggy__WEBPACK_IMPORTED_MODULE_2__.ZiggyVue, _ziggy__WEBPACK_IMPORTED_MODULE_3__.Ziggy).component("Link", _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_1__.Link).component("Head", _inertiajs_inertia_vue3__WEBPACK_IMPORTED_MODULE_1__.Head).mixin({
      methods: {
        route: route
      }
    }).mount(el);
