    ...
    <div class="section-body bg-gray-100">
        <div class="body-container">
            ...
            <div class="text-center py-5">
                ...
                <p>We'll work closely with you to further refine and then build that solution.</p>
            ...
            <div class="text-center py-5">
                ...
                <h3 class="pt-5 font-bold">We'll host and support the site</h3>
                <p>We'll make the site available over the internet, keep an eye on its performance, and make sure it continues to run well.</p>
                <p>Hosting a website can be expensive. If the cost gets too high after the first year, we may ask you to pay a small amount towards those costs.</p>
            </div>
            <div class="text-center py-5">
                <SectionNumber value="&amp;"/>
                <h3 class="pt-5 font-bold">The website is yours</h3>
                <p>You own the website, the code, and everything else associated with it.</p>
                <p>If you want to take it further, we'll help you find a software company to take over and stay involved as advisors to make sure things run smoothly.</p>
            </div>
        </div>
    </div>
</template>
